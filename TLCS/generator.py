...
class TrafficGenerator:
    def __init__(self, max_steps, n_cars_generated, args):
    ...
    def generate_routefile(self, seed):
        ...
        with open("intersection/episode_routes.rou.xml", "w") as routes:
            if self.args.car_type == "cars":
            ...
            elif self.args.car_type == 'motor':
                print("""<routes>
                <vTypeDistribution id="standard_car">
                    <vType id="type1" guiShape="bus" vClass="bus"  probability="0.05"/>
                    <vType id="type2" guiShape="truck" vClass="truck"  probability="0.05"/>
                    <vType id="type3" guiShape="moped" vClass="moped"  probability="0.3"/>
                    <vType accel="2.6" decel="4.5" id="standard_car_origin" guiShape="passenger" length="5.0" minGap="2.5" maxSpeed="31" sigma="0.5" probability="0.6"/>
                </vTypeDistribution>
                ...
                print("""<routes>
                <vTypeDistribution id="standard_car">
                    <vType accel="2.6" decel="4.5" id="standard_car_origin" guiShape="passenger" length="5.0" minGap="2.5" maxSpeed="31" sigma="0.5" probability="1"/>
                </vTypeDistribution>
